...
public class FloodGossip extends GenericProtocol {
    ...
    /*--------------------------------- Messages ---------------------------------------- */
    private void uponReceiveGossip(GossipMessage msg, Host from, short sourceProto, int channelId,String messageId) {
    ...
    private void uponBroadcast(BroadcastRequest request, short sourceProto) {
        ...
        uponReceiveGossip(msg, myself, PROTO_ID, -1,"NAO SEI");
